...
impl<'a> Event<'a> {
    ...
    pub const fn name(&self) -> &'static str {
        match self {
            ...
            Self::StartColocationAdvertisementCompleteMETA(_) => {
                "StartColocationAdvertisementCompleteMETA"
            }
            Self::ColocationAdvertisementCompleteMETA(_) => "ColocationAdvertisementCompleteMETA",
            Self::StopColocationAdvertisementCompleteMETA(_) => {
                "StopColocationAdvertisementCompleteMETA"
            }
            Self::StartColocationDiscoveryCompleteMETA(_) => "StartColocationDiscoveryCompleteMETA",
            Self::ColocationDiscoveryResultMETA(_) => "ColocationDiscoveryResultMETA",
            Self::ColocationDiscoveryCompleteMETA(_) => "ColocationDiscoveryCompleteMETA",
            Self::StopColocationDiscoveryCompleteMETA(_) => "StopColocationDiscoveryCompleteMETA",
            Self::ShareSpacesCompleteMETA(_) => "ShareSpacesCompleteMETA",
            ...
            Self::SpacesSaveResultMETA(_) => "SpacesSaveResultMETA",
            Self::SpacesEraseResultMETA(_) => "SpacesEraseResultMETA",
            Self::SpaceDiscoveryResultsAvailableMETA(_) => "SpaceDiscoveryResultsAvailableMETA",
            Self::SpaceDiscoveryCompleteMETA(_) => "SpaceDiscoveryCompleteMETA",
            ...
            Self::SpatialDiscoveryRecommendedEXT(_) => "SpatialDiscoveryRecommendedEXT",
            Self::PassthroughLayerResumedMETA(_) => "PassthroughLayerResumedMETA",
            Self::InteractionRenderModelsChangedEXT => "InteractionRenderModelsChangedEXT",
            Self::SenseDataProviderStateChangedBD(_) => "SenseDataProviderStateChangedBD",
            Self::SenseDataUpdatedBD(_) => "SenseDataUpdatedBD",
            Self::ViewConfigurationViewsChangedEXT(_) => "ViewConfigurationViewsChangedEXT",
        }
    }
}
#[derive(Copy, Clone, Debug)]
